  ...
  return (
    <div className="bg-black min-h-screen text-white overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-50 opacity-10 ">
        <div className={`w-full h-2 bg-green-400/30 absolute  ${scanline ? 'top-0' : ''}`} 
            style={{ 
      ...
      <div className="fixed inset-0 pointer-events-none z-0 opacity-20"
        style={{
          backgroundImage: "linear-gradient(rgba(0, 255, 123, 0.2) 1px, transparent 1px), linear-gradient(90deg, rgba(0, 255, 123, 0.2) 1px, transparent 1px)",
      ...
      <div className="relative z-10 container mx-auto px-4 py-12 mt-12">
        ...
        <div className="text-center mb-10 relative">
          ...
          <h1 className={`text-5xl font-bold mb-6 inline-block ${glitchText ? 'glitch-text' : ''}`}
            style={{ 
              fontFamily: "'Press Start 2P', monospace", 
              color: "#00ff7b",
              textShadow: "0 0 10px rgba(0, 255, 123, 0.8), 0 0 20px rgba(0, 255, 123, 0.4)",
              letterSpacing: "1px",
          ...
          <div className="relative rounded-md z-10 border border-green-400/70 bg-black shadow-lg overflow-hidden">
            ...
            <div className="p-6 relative overflow-hidden"
              style={{
                ...
                boxShadow: "inset 0 0 30px rgba(0, 0, 0, 0.8), 0 0 15px rgba(0, 255, 123, 0.5)",
              }}>
                ...
                <div className="text-center py-10 animate-fadeIn space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-center space-x-1 mt-2">
                      ...
                      <div className="h-1 w-1 bg-green-400 rounded-full animate-ping" style={{animationDelay: "0.2s"}}></div>
                      <div className="h-1 w-1 bg-green-400 rounded-full animate-ping" style={{animationDelay: "0.4s"}}></div>
                    </div>
                  </div>
                  ...
                  <div className="mx-auto max-w-md border border-green-400/40 rounded p-3 bg-black/30 font-mono text-sm text-gray-200/80 text-left">
                    <div className="text-green-400/90 mb-1">> Connection status:</div>
                    <div className="pl-4 mb-3">AWAITING_RESPONSE</div>
                    <div className="text-green-400/90 mb-1">> Estimated response time:</div>
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6 relative">
                    <div className="form-group">
                      <label htmlFor="name" className="flex items-center text-green-400 mb-2 font-mono text-sm">
                        <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="form-group">
                      <label htmlFor="email" className="flex items-center text-green-400 mb-2 font-mono text-sm">
                        <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="form-group">
                      <label htmlFor="message" className="flex items-center text-green-400 mb-2 font-mono text-sm">
                        <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="relative flex items-center">
                          {loading ? (
                            <>
                              ...
                              <span className="font-mono text-sm tracking-wider">INITIATING...</span>
                            </>
                          ) : (
                            <>
                              <span className="font-mono text-sm tracking-wider">TRANSMIT_DATA</span>
      ...
      <style jsx global>{`
        ...
        @keyframes glitch-anim {
          0% { clip: rect(11px, 9999px, 30px, 0); }
          5% { clip: rect(90px, 9999px, 140px, 0); }
          10% { clip: rect(38px, 9999px, 4px, 0); }
          15% { clip: rect(106px, 9999px, 74px, 0); }
          20% { clip: rect(24px, 9999px, 90px, 0); }
          25% { clip: rect(85px, 9999px, 140px, 0); }
          30% { clip: rect(38px, 9999px, 4px, 0); }
          35% { clip: rect(106px, 9999px, 74px, 0); }
          40% { clip: rect(24px, 9999px, 90px, 0); }
          45% { clip: rect(85px, 9999px, 140px, 0); }
          50% { clip: rect(38px, 9999px, 4px, 0); }
          55% { clip: rect(106px, 9999px, 74px, 0); }
          60% { clip: rect(24px, 9999px, 90px, 0); }
          65% { clip: rect(85px, 9999px, 140px, 0); }
          70% { clip: rect(38px, 9999px, 4px, 0); }
          75% { clip: rect(106px, 9999px, 74px, 0); }
          80% { clip: rect(24px, 9999px, 90px, 0); }
          85% { clip: rect(85px, 9999px, 140px, 0); }
          90% { clip: rect(38px, 9999px, 4px, 0); }
          95% { clip: rect(106px, 9999px, 74px, 0); }
          100% { clip: rect(11px, 9999px, 30px, 0); }
        }
        
        @keyframes glitch-anim-2 {
          0% { clip: rect(66px, 9999px, 90px, 0); }
          5% { clip: rect(36px, 9999px, 100px, 0); }
          10% { clip: rect(68px, 9999px, 94px, 0); }
          15% { clip: rect(6px, 9999px, 24px, 0); }
          20% { clip: rect(16px, 9999px, 64px, 0); }
          25% { clip: rect(36px, 9999px, 100px, 0); }
          30% { clip: rect(68px, 9999px, 94px, 0); }
          35% { clip: rect(6px, 9999px, 24px, 0); }
          40% { clip: rect(16px, 9999px, 64px, 0); }
          45% { clip: rect(36px, 9999px, 100px, 0); }
          50% { clip: rect(68px, 9999px, 94px, 0); }
          55% { clip: rect(6px, 9999px, 24px, 0); }
          60% { clip: rect(16px, 9999px, 64px, 0); }
          65% { clip: rect(36px, 9999px, 100px, 0); }
          70% { clip: rect(68px, 9999px, 94px, 0); }
          75% { clip: rect(6px, 9999px, 24px, 0); }
          80% { clip: rect(16px, 9999px, 64px, 0); }
          85% { clip: rect(36px, 9999px, 100px, 0); }
          90% { clip: rect(68px, 9999px, 94px, 0); }
          95% { clip: rect(6px, 9999px, 24px, 0); }
          100% { clip: rect(66px, 9999px, 90px, 0); }
        }
      `}</style>
    </div>
  );
