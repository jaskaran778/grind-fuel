...
export default function About() {
  ...
  const opacitySection2 = useTransform(scrollYProgress, [0.05, 0.15], [0, 1]);
  const opacitySection3 = useTransform(scrollYProgress, [0.15, 0.25], [0, 1]);
  const opacitySection4 = useTransform(scrollYProgress, [0.25, 0.35], [0, 1]);
  const opacitySection5 = useTransform(scrollYProgress, [0.35, 0.45], [0, 1]);
